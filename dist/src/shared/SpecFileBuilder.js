...
const describe_1 = __importDefault(require("./templates/describe"));
const masterServiceInit_1 = __importDefault(require("./templates/masterServiceInit"));
const import_1 = __importDefault(require("./templates/import"));
